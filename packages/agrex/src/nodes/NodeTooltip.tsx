    ...
    <div style={{ position: 'relative' }} className="agrex-tooltip-wrapper">
      ...
      <div
        style={{
          ...
          top: 'calc(100% + 6px)', opacity: 0, whiteSpace: 'nowrap',
          background: 'var(--agrex-node-fill)', border: '1px solid var(--agrex-node-border)',
          borderRadius: 6, padding: '2px 8px', fontSize: 12, color: 'var(--agrex-fg)', zIndex: 50,
